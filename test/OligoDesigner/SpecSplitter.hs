...
splitSequence :: Spec
splitSequence =
    describe "splitSequence" $ do
        it "should correct split sequence for 4 1 1" $ do
        ...
        it "should correct split sequence for 5 1 1" $ do
...
realExampleWithGap =
    ...
    it "should correct split sequence with quality 0.7" $ do 
    ...
    it "should correct split sequence with quality 0.3" $ do 
        let conf = OligsSplittingConfig 60 0.3 18
        let res = fromMaybe emptySplitting (split conf 600)
        strand5 res `shouldBe` [(0,60),(63,123),(126,186),(189,249),(252,312),(315,375),(378,438),(441,501),(504,564)]
        strand3 res `shouldBe` [(32,92),(95,155),(158,218),(221,281),(284,344),(347,407),(410,470),(473,533),(536,600)]
    it "should correct split sequence with quality 0.7 and len 355" $ do 
        let conf = OligsSplittingConfig 60 0.7 18
