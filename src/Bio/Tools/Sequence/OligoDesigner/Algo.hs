...
type Olig = (Int, Int)
data OligSplitting = OligSplitting {strand5 :: [Olig], strand3 :: [Olig]} deriving (Show, Eq)
...
findOptimalSplitting _ _ _ []                            =  trace ("findOptimalSplitting") $ Nothing
...
countOligsCount _ _ _ _ []                               = trace ("countOligsCount") $ Nothing
